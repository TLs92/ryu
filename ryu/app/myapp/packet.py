...
class ExampleSwitch(app_manager.RyuApp):
    ...
    def packet_in_handler(self, ev):
        ...
        '''
        print('pkt1\n')
        pkt1 = packet.Packet(array.array('B',ev.msg.data))
        ...
        self.logger.info("packet in dpid:%s src:%s dst:%s in_port:%s",
                         dpid, src, dst, in_port)      # print out these information

        print('\n\n\n\n')

        # learn a source_mac address to avoid Flood next time.
        self.mac_to_port[dpid][src] = in_port

        # if the dst_mac address has already learned.
        # decide which port to send the packet. otherwise,flood.
